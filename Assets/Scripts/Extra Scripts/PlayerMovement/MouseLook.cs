...
public class MouseLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localRotation = Quaternion.Euler(xRotation, 0f, 0f);        // Rotate Player Head (Camera) Up and Down
        playerBody.Rotate(Vector3.up * mouseX);                          // Rotate Player Body (Capsule) Left and Right
